...
<div class="right_col" role="main">
    <div class="row">
        <div class="col-sm-offset-2 col-sm-8">
            ...
            if (isset($_POST['send_pic'])) {
                ...
                if (empty($image_name) || empty($picture_date)) {
                    ...
                    if (mysqli_num_rows($rs) > 0) {
                        ...
                        $query = "insert into gallery_tbl(image_name,image_date) values('$image_name','$picture_date')";
                        if (mysqli_query($link, $query) && move_uploaded_file($_FILES['picture_name']['tmp_name'], $path . $image_name)) {
                            message("success", "Image Are Added Successfully......");
                        } else {
            ...
            ?>
            <form name="picture_form" method="post" action="add_picture.php" onsubmit="return add_picture();" enctype="multipart/form-data">
